...
import com.refushi.Login_activity;
import com.refushi.MainActivity;
import com.refushi.R;
//import com.google.android.gms.internal.fo;

public class FragmentViewPager3 extends Fragment implements OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_go_to_Login:
            	Intent intent_go_to_Login = new Intent(this.getActivity(), Login_activity.class);
            	startActivity(intent_go_to_Login);
                break;
        }
    }
	
	public static FragmentViewPager3 newInstance(String text) {

		FragmentViewPager3 f = new FragmentViewPager3();
        Bundle b = new Bundle();
